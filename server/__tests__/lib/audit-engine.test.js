...
describe('Clause Detection Logic', () => {
  // Use the shared engine module — single source of truth (no copy-paste).
  const { detectClauses } = require('../../lib/audit-engine');
...
describe('Gap Analysis', () => {
  const { analyzeGaps } = require('../../lib/audit-engine');
...
describe('Risk Scoring', () => {
  const { scoreRisk } = require('../../lib/audit-engine');
