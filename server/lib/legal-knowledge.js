...
const REGULATIONS = [
  ...
  },
  {
    ...
    articles: [
      ...
      { articleNum: '33', title: 'Penalties', content: 'Penalties up to INR 250 crore (approximately $30 million) for significant data protection breaches.', summary: 'Fines up to approximately $30 million.', relevance: 'Significant financial penalties increase DPA compliance importance.', relatedClauses: 'liability' }
    ]
  },
  {
    code: 'PIPEDA',
